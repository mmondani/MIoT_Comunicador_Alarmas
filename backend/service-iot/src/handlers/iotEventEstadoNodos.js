...
import { parseHeader, parseRegisterEstadoNodos } from "../lib/parser";
...
async function iotEventEstadoNodos(event, context) {
  ...
  try {
    ...
    await db.collection("devices").updateOne (
      ...
      {$set:{
        "particiones.$.nodosEncendidos": payloadParsed.nodosEncendidos
      }}
    );
...
export const handler = iotEventEstadoNodos;
