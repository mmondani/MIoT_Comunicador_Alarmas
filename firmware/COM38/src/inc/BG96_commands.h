...
const char bg96_qsslcfgCaCert[]="AT+QSSLCFG=\"cacert\",";
const char bg96_qsslcfgClientCert[]="AT+QSSLCFG=\"clientcert\",";
const char bg96_qsslcfgClientKey[]="AT+QSSLCFG=\"clientkey\",";
const char bg96_qsslcfgSecLevel[]="AT+QSSLCFG=\"seclevel\",";
